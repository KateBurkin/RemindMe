...
class NotificationService: UNNotificationServiceExtension {
    ...
    override func didReceive(_ request: UNNotificationRequest, withContentHandler contentHandler: @escaping (UNNotificationContent) -> Void) {
        ...
        let likeAction = UNNotificationAction(identifier: "done", title: "Done", options: [])
        let saveAction = UNNotificationAction(identifier: "defer", title: "Defer", options: [])
        let category = UNNotificationCategory(identifier: "choreMinder", actions: [likeAction, saveAction], intentIdentifiers: [], options: [])
